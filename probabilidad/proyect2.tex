...
\begin{document}
	\begin{center}
	\LARGE \noindent {\bf UNIVERSIDAD NACIONAL DE INGENIERÍA}\\
...
\begin{center}
\textbf{\textcolor{blue}{Objetivo del Proyecto}}\\[1cm]
\end{center}
\begin{multicols}{2}
...
\begin{center}
\textbf{\textcolor{blue}{Estado del arte}}\\[1cm]
\end{center}
\begin{enumerate}
\begin{multicols}{2}
